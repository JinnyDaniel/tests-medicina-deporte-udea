...
5. Arrastra los 8 archivos de esta carpeta (`index.html`, `milla.html`, `jspdf.umd.min.js`, `mi-logo.png`, `favicon.ico`, `favicon.png`, `formula-vo2-lmin.png`, `formula-vo2-relativo.png`) a la ventana del navegador, o haz clic en "choose your files" y selecciónalos todos a la vez.
